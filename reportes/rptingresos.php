...
$pdf->Cell(40,6,'',0,0,'C');
$pdf->Cell(120,8,utf8_decode('LISTA DE INGRESOS'),1,0,'C'); 
$pdf->Ln(12);
...
{  
    ...
    $pdf->Row(array($fecha,utf8_decode($proveedor),utf8_decode($usuario),$tipo_comprobante,$num_comprobante,$total_compra, $impuesto, $estado));
}

//Mostramos el documento pdf
$pdf->Output($dest='', $name='Lista de Ingresos.pdf', $isUTF8=true);
}
else
{

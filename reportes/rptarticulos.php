...
$pdf->Cell(40,6,'',0,0,'C');
$pdf->Cell(100,8,utf8_decode('LISTA DE ARTÍCULOS'),1,0,'C'); 
$pdf->Ln(12);
...
$pdf->Cell(40,6,utf8_decode('Descripción'),1,0,'C',1);
$pdf->Ln(10);
...
$pdf->SetWidths(array(60,50,30,12,40));
...
$pdf->Output($dest='', $name='Lista de Artículos.pdf', $isUTF8=true);
}
else
{

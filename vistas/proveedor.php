              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Proveedor <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> <a id="btnreporte" target="_blank" href="../reportes/rptproveedores.php"><button class="btn btn-info"> <i class="fa fa-list-alt"></i> Reporte</button></a></h1>
